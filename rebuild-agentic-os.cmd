...
powershell -NoProfile -Command "$c = Get-NetTCPConnection -LocalPort 3939 -State Listen -ErrorAction SilentlyContinue; if ($c) { $c | ForEach-Object { Stop-Process -Id $_.OwningProcess -Force } }"
timeout /t 2 >nul
cd /d D:\AgenticOS
...
echo Done. Open http://localhost:3939 in a few seconds.
timeout /t 3 >nul
